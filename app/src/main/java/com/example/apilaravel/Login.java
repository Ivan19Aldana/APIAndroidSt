...
public class Login extends AppCompatActivity {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if ("Ingreso Exitoso, Bienvenido".equals(message)) {
                                irFormulario();
                            } else {
                                Toast.makeText(Login.this, "Error, Verifique los datos.", Toast.LENGTH_SHORT).show();
                            }
    ...
    private void irRegistro() {
        Intent irRegistro = new Intent(this, Register.class);
