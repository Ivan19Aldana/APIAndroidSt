                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if ("Usuario Registrado".equals(message)) {
                                ...
                                Toast.makeText(Register.this, "No se pudo registrar, verifique los datos", Toast.LENGTH_SHORT).show();
                            }
            ...
            public void onErrorResponse(VolleyError error) {
                if (error.networkResponse != null && error.networkResponse.statusCode == 400) { // Asumiendo que el código 400 es para la respuesta del error
                    try {
                        ...
                        Toast.makeText(Register.this, errorMessages.toString(), Toast.LENGTH_LONG).show();

                    } catch (JSONException e) {
                        e.printStackTrace();
                        Toast.makeText(Register.this, "Error al procesar la respuesta", Toast.LENGTH_SHORT).show();
                    }
                } else {
